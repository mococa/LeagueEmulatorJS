      ...
      <section class="w-full max-w-3xl min-h-screen my-0 mx-auto flex items-center p-6 flex-wrap md:flex-nowrap">
        <article class="w-full mb-5">
          ...
          <p class="block mt-4">
            ...
            <Link href="vscode://file//home/mococa/repos/LeagueEmulatorJS/apps/gameclient/src">src folder</Link>.
          </p>
          <ul class="block leading-snug mt-4">
            <li>
              <ActionLink href="https://nullstack.app/stateless-components">🎉 Create your first component </ActionLink>
            </li>
            <li>
              <ActionLink href="https://nullstack.app/routes-and-params">✨ Set your first route</ActionLink>
            </li>
            <li>
